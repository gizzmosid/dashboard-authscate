...
const addnft=(e)=>{
  e.preventDefault()
  axios.post("/nfts",{title,about,symbol,price,photo,date}).then(()=>{
    setTitle("");
    setAbout("");
    setSymbol("");
    setPrice("0");
...
<input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 purple:text-gray-400 focus:outline-none purple:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="file_input" type="file" onChange={(e)=>setPhoto(e.target.value)} value={photo}/>
